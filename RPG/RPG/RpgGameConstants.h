...
enum CRAFTING_STATIONS {
    NO_CRAFTING_STATION,
    CRAFTING_STATION_WOOD_WORKING_BENCH,
    CRAFTING_STATION_FORGE,
    CRAFTING_STATION_CAMP_FIRE,
    CRAFTING_STATION_STOVE,
    CRAFTING_STATION_FURNACE,
    NUM_CRAFTING_STATIONS
};
...
enum DOODAD_TYPES {
    ...
    DOODAD_TREASURE_CHEST,
    DOODAD_CAMP_FIRE,
    DOODAD_MINEBLOCK,
    DOODAD_FURNACE,
    DOODAD_UNIT_SPAWNER,        //must be (second) last item in this enum
    NUM_DOODAD_TYPES
};
...
enum SAVE_OBJECTS {
    ...
    SAVED_RPG_TOWN,
    SAVED_RPG_PROVINCE,
    SAVED_UNIT_SKILL_ATTR,
    SAVED_UNIT_SKILL_ATTR_VECTOR,
    SAVED_MINEBLOCK
};
...
enum MENUS {
    ...
    SAVE_GAME_MENU,
    CRAFTING_MENU,
    WORLD_BUILDING_NEW_ZONE_MENU,
    LOAD_GAME_MENU,
    OTHER_UNIT_INVENTORY_MENU
};
...
enum TEXTURE_NAMES
{
    ...
    BUILDING_ICON_HOUSE,
    TEXTURE_GUARDHOUSE_TOP,
    TEXTURE_GUARDHOUSE_BOTTOM,
    TEXTURE_PICKET_FENCE_BOTTOM,
    TEXTURE_PICKET_FENCE_TOP,
    TEXTURE_PICKET_FENCE_RIGHT,
    TEXTURE_PICKET_FENCE_LEFT,
    TEXTURE_PICKET_FENCE_BOTTOM_RIGHT,
    TEXTURE_PICKET_FENCE_BOTTOM_LEFT,
    TEXTURE_PICKET_FENCE_TOP_RIGHT,
    TEXTURE_PICKET_FENCE_TOP_LEFT,
    TEXTURE_LARGE_ARROW_RIGHT,
    TEXTURE_BACKGROUND_TREE,
    TEXTURE_BRONZE_HELM,
    TEXTURE_BRONZE_BODY,
    TEXTURE_BRONZE_PANTS,
    TEXTURE_BRONZE_GLOVES,
    TEXTURE_BRONZE_BOOTS,
    TEXTURE_CHEST_CLOSED,
    TEXTURE_CHEST_OPEN,
    TEXTURE_TEST_PROJECTILE,
    TEXTURE_CRUDE_HIDE,
    TEXTURE_SCRAP_MEAT,
    ...
    TEXTURE_FURNACE,
    TEXTURE_BOW,
    TEXTURE_ARROW_UP_RIGHT,
    TEXTURE_ARROW_UP,
    TEXTURE_ARROW_UP_LEFT,
    TEXTURE_ARROW_LEFT,
    TEXTURE_ARROW_DOWN_LEFT,
    TEXTURE_ARROW_DOWN,
    TEXTURE_ARROW_DOWN_RIGHT,
    TEXTURE_ARROW_RIGHT,
    NUM_TEXTURES
};
...
enum WORLD_BUILDER_INPUT_COMMANDS {
    ...
    WORLD_BUILDER_PLACE_UNIT,
    OPEN_PLACED_UNIT_OPTIONS_MENU,
    WORLD_BUILDER_CREATE_NEW_ZONE
};
...
enum OVERWORLD_INPUT_COMMANDS {
    ...
    OVERWORLD_FORCE_COMMAND_UNIT,
    OVERWORLD_ASSIGN_UNIT,
    OVERWORLD_PLAYER_CRAFT
};
...
enum BUILDING_TYPES {
    ...
    BUILDING_HOUSE,
    BUILDING_GUARDHOUSE,
    BUILDING_APPLE_ORCHARD,
    BUILDING_SMELTING_WORKS,
    NUM_BUILDING_TYPES
};