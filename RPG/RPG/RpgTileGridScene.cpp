...
void RpgTileGridScene::createTiles()
{
    ...
    mapTiles[GRASS] = MapTile(UNIT_PASSABLE, GRASS);
    mapTiles[TEXTURE_GRASS_2] = MapTile(UNIT_PASSABLE, TEXTURE_GRASS_2);
    mapTiles[TEXTURE_GRASS_3] = MapTile(UNIT_PASSABLE, TEXTURE_GRASS_3);
    mapTiles[TEXTURE_GRASS_4] = MapTile(UNIT_PASSABLE, TEXTURE_GRASS_4);
    mapTiles[TEXTURE_GRASS_5] = MapTile(UNIT_PASSABLE, TEXTURE_GRASS_5);
    mapTiles[TREE] = MapTile(UNPASSABLE, TREE);
    mapTiles[WATER] = MapTile(PROJECTILE_PASSABLE, WATER);
    mapTiles[MOUNTAIN] = MapTile(UNPASSABLE, MOUNTAIN);
    mapTiles[WOOD_WALL_ONE] = MapTile(UNPASSABLE, WOOD_WALL_ONE);
    mapTiles[WOOD_WALL_TWO] = MapTile(UNPASSABLE, WOOD_WALL_TWO);
    mapTiles[CAVE_FILL] = MapTile(UNPASSABLE, CAVE_FILL);
    mapTiles[CAVE_PATH] = MapTile(UNIT_PASSABLE, CAVE_PATH);
    mapTiles[CAVE_WALL_TOP] = MapTile(UNPASSABLE, CAVE_WALL_TOP);
    mapTiles[CAVE_WALL_BOTTOM] = MapTile(UNPASSABLE, CAVE_WALL_BOTTOM);
    mapTiles[TILE_DIRT_ROAD] = MapTile(UNIT_PASSABLE, TILE_DIRT_ROAD);
    mapTiles[TEXTURE_COAST_LEFT] = MapTile(PROJECTILE_PASSABLE, TEXTURE_COAST_LEFT);
    mapTiles[TEXTURE_COAST_RIGHT] = MapTile(PROJECTILE_PASSABLE, TEXTURE_COAST_RIGHT);
    mapTiles[TEXTURE_COAST_TOP] = MapTile(PROJECTILE_PASSABLE, TEXTURE_COAST_TOP);
    mapTiles[TEXTURE_COAST_BOTTOM] = MapTile(PROJECTILE_PASSABLE, TEXTURE_COAST_BOTTOM);
    mapTiles[TEXTURE_COAST_TOP_LEFT] = MapTile(PROJECTILE_PASSABLE, TEXTURE_COAST_TOP_LEFT);
    mapTiles[TEXTURE_COAST_TOP_RIGHT] = MapTile(PROJECTILE_PASSABLE, TEXTURE_COAST_TOP_RIGHT);
    mapTiles[TEXTURE_COAST_BOTTOM_LEFT] = MapTile(PROJECTILE_PASSABLE, TEXTURE_COAST_BOTTOM_LEFT);
    mapTiles[TEXTURE_COAST_BOTTOM_RIGHT] = MapTile(PROJECTILE_PASSABLE, TEXTURE_COAST_BOTTOM_RIGHT);
    mapTiles[TEXTURE_PICKET_FENCE_BOTTOM] = MapTile(UNPASSABLE, TEXTURE_PICKET_FENCE_BOTTOM);
    mapTiles[TEXTURE_PICKET_FENCE_BOTTOM_LEFT] = MapTile(UNPASSABLE, TEXTURE_PICKET_FENCE_BOTTOM_LEFT);
    mapTiles[TEXTURE_PICKET_FENCE_BOTTOM_RIGHT] = MapTile(UNPASSABLE, TEXTURE_PICKET_FENCE_BOTTOM_RIGHT);
    mapTiles[TEXTURE_PICKET_FENCE_LEFT] = MapTile(UNPASSABLE, TEXTURE_PICKET_FENCE_LEFT);
    mapTiles[TEXTURE_PICKET_FENCE_RIGHT] = MapTile(UNPASSABLE, TEXTURE_PICKET_FENCE_RIGHT);
    mapTiles[TEXTURE_PICKET_FENCE_TOP] = MapTile(UNPASSABLE, TEXTURE_PICKET_FENCE_TOP);
    mapTiles[TEXTURE_BACKGROUND_TREE] = MapTile(UNPASSABLE, TEXTURE_BACKGROUND_TREE);
    resizeTiles();
}
