...
void SkeletonKing::setDropTable()
{
    ...
    dropTable.items.push_back({ 0.01, ITEM_RAG_BODY });
    dropTable.items.push_back({ 0.01, ITEM_RAG_BOOTS });
    dropTable.items.push_back({ 0.01, ITEM_RAG_GLOVES });
    dropTable.items.push_back({ 0.01, ITEM_RAG_HAT });
    dropTable.items.push_back({ 0.01, ITEM_RAG_PANTS });
    dropTable.items.push_back({ 0.05, ITEM_LINEN_BODY });
    dropTable.items.push_back({ 0.05, ITEM_LINEN_BOOTS });
    dropTable.items.push_back({ 0.05, ITEM_LINEN_GLOVES });
    dropTable.items.push_back({ 0.05, ITEM_LINEN_HAT });
    dropTable.items.push_back({ 0.05, ITEM_LINEN_PANTS });
    dropTable.items.push_back({ 0.09, ITEM_LEATHER_BODY });
    dropTable.items.push_back({ 0.09, ITEM_LEATHER_BOOTS });
    dropTable.items.push_back({ 0.09, ITEM_LEATHER_GLOVES });
    dropTable.items.push_back({ 0.09, ITEM_LEATHER_HAT });
    dropTable.items.push_back({ 0.09, ITEM_LEATHER_PANTS });
    dropTable.items.push_back({ 0.01, ITEM_BRONZE_BODY });
    dropTable.items.push_back({ 0.01, ITEM_BRONZE_BOOTS });
    dropTable.items.push_back({ 0.01, ITEM_BRONZE_GLOVES });
    dropTable.items.push_back({ 0.01, ITEM_BRONZE_HELM });
    dropTable.items.push_back({ 0.01, ITEM_BRONZE_PANTS });
    dropTables.push_back(dropTable);

    dropTable = DropTable();
    dropTable.chance = 0.90;
    dropTable.items.push_back({ 0.1, ITEM_MACE });
    dropTable.items.push_back({ 0.1, ITEM_LONG_SWORD });
    dropTable.items.push_back({ 0.01, ITEM_RAG_BODY });
    dropTable.items.push_back({ 0.01, ITEM_RAG_BOOTS });
